...
const canvascurvascubicas = document.getElementById("canvascurvascubicas");
const canvasCombinado = document.getElementById("canvasCombinado");
...
function drawrec() {
  ...
  function drawcurvascubicas() {
    
    if (canvascurvascubicas.getContext) {
      const ctx = canvascurvascubicas.getContext("2d");
